---
name: Read replit.md first
description: replit.md contains required workflow obligations, guidance doc triggers, and a mandatory post-task summary format. Must be read at the start of every session.
---

# Read replit.md at the start of every session
...
**How to apply:** On any new session, read `replit.md` before touching any code. Then open guidance docs as triggered by the "Read when" conditions in the System Guidance Documents section.

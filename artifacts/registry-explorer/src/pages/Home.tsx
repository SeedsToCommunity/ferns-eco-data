...
const GROUP_DESCRIPTIONS: Record<string, string> = {
  source_wrapper:
    "Direct adapters wrapping external authoritative datasets with consistent data layer interfaces.",
  derived_synthesis:
  ...
  system: "Internal registry and routing services powering the data layer.",
};
    ...
    <Layout>
      <div className="mb-12 md:mb-16 max-w-3xl">
        ...
        >
          ...
          endpoints in the Ecological Commons data layer.
        </motion.p>
      </div>
      {isLoading && (
        ...
        <div className="bg-destructive/5 border border-destructive/20 rounded-2xl p-8 flex flex-col items-center justify-center text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-4">
            {error instanceof Error
              ? error.message
              : "The registry is currently unreachable."}
          </p>
          <button

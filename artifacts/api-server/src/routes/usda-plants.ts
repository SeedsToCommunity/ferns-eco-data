  ...
  try {
    ...
    res.json({
      ...
      data: {
        species: speciesParam,
        Symbol: symbol,
        ScientificName: nameMatch.canonical_name,
        CommonName: nameMatch.common_name,
        Rank: nameMatch.rank,
        usda_id: nameMatch.usda_id,
        profile_url: profileUrl(symbol),
        NativeStatuses: profile["NativeStatuses"] ?? null,
        WetlandData: profile["WetlandData"] ?? null,
        LegalStatuses: profile["LegalStatuses"] ?? null,
        Durations: profile["Durations"] ?? null,
        GrowthHabits: profile["GrowthHabits"] ?? null,
        Group: profile["Group"] ?? null,
        Ancestors: profile["Ancestors"] ?? null,
        Synonyms: profile["Synonyms"] ?? null,
        FactSheetUrls: profile["FactSheetUrls"] ?? [],

...
import {
  S2C_SOURCE_ID,
  S2C_DERIVATION_SUMMARY,
  S2C_DERIVATION_SCIENTIFIC,
  S2C_REGISTRY_ENTRY,
...
function buildProvenance(req: Parameters<typeof resolveUrl>[0]) {
  return {
    ...
    fetched_at: new Date(),
    method: "static_data",
    upstream_url: resolveUrl(req, "/api/s2c"),
    derivation_summary: S2C_DERIVATION_SUMMARY,
    derivation_scientific: S2C_DERIVATION_SCIENTIFIC,
  };
}

    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          non_passthrough_endpoints: GOOGLE_IMAGES_REGISTRY_ENTRY.non_passthrough_endpoints ?? [],
          website_url_patterns: GOOGLE_IMAGES_REGISTRY_ENTRY.website_url_patterns ?? {},
          updated_at: new Date(),
        },
      });
    seeded = true;

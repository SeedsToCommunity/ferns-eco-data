    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          rights: MISSOURI_PLANTS_REGISTRY_ENTRY.rights,
          website_url_patterns: MISSOURI_PLANTS_REGISTRY_ENTRY.website_url_patterns,
          ...
          knowledge_type: MISSOURI_PLANTS_REGISTRY_ENTRY.knowledge_type,
          non_passthrough_endpoints: MISSOURI_PLANTS_REGISTRY_ENTRY.non_passthrough_endpoints ?? [],
          updated_at: new Date(),
        },
      });
    seeded = true;

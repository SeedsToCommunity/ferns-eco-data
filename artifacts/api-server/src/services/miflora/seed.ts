    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          rights: MIFLORA_REGISTRY_ENTRY.rights,
          website_url_patterns: MIFLORA_REGISTRY_ENTRY.website_url_patterns,
          ...
          knowledge_type: MIFLORA_REGISTRY_ENTRY.knowledge_type,

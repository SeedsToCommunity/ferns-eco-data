    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          permission_granted: MINNESOTA_WILDFLOWERS_REGISTRY_ENTRY.permission_granted ?? null,
          permission_status: MINNESOTA_WILDFLOWERS_REGISTRY_ENTRY.permission_status ?? null,

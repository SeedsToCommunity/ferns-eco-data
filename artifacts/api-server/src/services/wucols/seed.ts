    ...
    await db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          licenses: WUCOLS_REGISTRY_ENTRY.licenses ?? [],
          license_notes: WUCOLS_REGISTRY_ENTRY.license_notes ?? "",
          general_summary: WUCOLS_REGISTRY_ENTRY.general_summary ?? null,
          technical_details: WUCOLS_REGISTRY_ENTRY.technical_details ?? null,
          permission_granted: WUCOLS_REGISTRY_ENTRY.permission_granted,
          license: WUCOLS_REGISTRY_ENTRY.license,
          rights: WUCOLS_REGISTRY_ENTRY.rights,
          website_url_patterns: WUCOLS_REGISTRY_ENTRY.website_url_patterns ?? {},
          non_passthrough_endpoints: WUCOLS_REGISTRY_ENTRY.non_passthrough_endpoints ?? [],
          updated_at: new Date(),
        },
      });
